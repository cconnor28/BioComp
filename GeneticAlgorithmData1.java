 ...
 * @author Charlie
 */
public class GeneticAlgorithmData1 {

    static int N = 600; //Number of genes
    ...
    static int[] Variables = new int[192]; //Array of the Variables from the input file
    static DataFile[] DataSet = new DataFile[32]; // Array of the data file
    static int RuleLength = 6; // Length of varibles and outputs in a rule
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (
                // writer
                FileWriter writer = new FileWriter("Data 1 Output.csv")) {
    ...
    public static void initialise() {
        ...
        Scanner sc = new Scanner(GeneticAlgorithmData1.class.getResourceAsStream("data1.txt"));
